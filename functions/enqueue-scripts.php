...
function site_scripts()
{
    ...
    wp_enqueue_style('site-css', get_template_directory_uri() . '/assets/styles/server/style.css', 'font-css', filemtime(get_template_directory() . '/assets/styles/server/'), 'all');
